...
namespace MHGameWork.TheWizards.DualContouring
{
    ...
    {
        private IQefCalculator qefCalculator;

        public DCUniformGridAlgorithm(): this(new IterativeQefCalculator())
        {
        }

        public DCUniformGridAlgorithm(IQefCalculator qefCalculator)
        {
            this.qefCalculator = qefCalculator;
        }
        ...
        public void buildTriangleIndices(List<int> indices, AbstractHermiteGrid grid, Dictionary<Point3, int> vIndex, List<DCVoxelMaterial> triangleMaterials)
        {
            // Possible quads
        ...
        public void createQEFVertices(List<Vector3> vertices, AbstractHermiteGrid grid, Dictionary<Point3, int> vIndex)
        {
