...
//        /// <returns></returns>
//        public static HermiteDataGrid FromIntersectableGeometry(float gridWorldSize, int resolution, Matrix4x4 world, IIntersectableObject obj)
//        {
//            var numCubes = new Point3(resolution, resolution, resolution);
//            var grid = new HermiteDataGrid();

//            var gridToWorld = Matrix4x4.Scaling(1f / resolution, 1f / resolution, 1f / resolution) * Matrix4x4.Scaling(new Vector3(gridWorldSize));
//            var gridToGeometry = gridToWorld * Matrix4x4.Invert(world);
//            var geometryToGrid = Matrix4x4.Invert(gridToGeometry);
